...
#Objetivo: Calcular a área da parede e a quantidade de tinta necessária para pintá-la.
#Aprendizado: Aprender a realizar cálculos simples e a trabalhar com variáveis em Python.
